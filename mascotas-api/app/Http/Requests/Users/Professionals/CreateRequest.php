...
class CreateRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'instagram' => 'max:30|regex:/^[a-z\d._]{3,}$/i',
            'facebook' => 'max:50|regex:/^[a-z\d._]{3,}$/i',
            'web' => 'max:50|nullable|regex:/^(ftp|http|https):\/\/[^ "]+$/',
    ...
    public function messages() {
        return [
            ...
            'instagram.regex' => 'El formato del usuario de Instagram no es válido',
            'facebook.max' => 'El nombre de usuario de Facebook no puede tener más de :max caracteres', 
            'facebook.regex' => 'El formato del usuario de Facebook no es válido',
            'web.max' => 'La url no puede contener más de :max caracteres',
            'web.regex' => 'El formato de la url no es válido',
