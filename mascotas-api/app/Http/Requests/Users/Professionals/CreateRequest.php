...
class CreateRequest extends FormRequest
{
    ...
    public function messages() {
        return [
            ...
            'email_visible.required' => Validation::msg_required('si el correo electrónico es visible al público'),
            ...
            'user_types.*.exists' => Validation::msg_valid_value('el tipo de servicio'),
            'user_types.*.integer' => Validation::msg_valid_value('el tipo de servicio'),
            'photo.required' => Validation::msg_required('una imagen de perfil'),
